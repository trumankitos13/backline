...
describe("SignupSteps", () => {
  ...
  it("enters the app only after the profile is persisted", async () => {
  ...
  it("keeps a taken handle on the signup screen", async () => {
  ...
  it("reports a failed write instead of silently dropping the profile", async () => {
  ...
  it("rejects a handle the database would refuse", async () => {
    const interaction = userEvent.setup();
    render(<SignupSteps />);
