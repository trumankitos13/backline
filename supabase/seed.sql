...
insert into public.musicians (id, name, handle, bio, genres, gear, neighborhood, distance_miles, rate_min, rate_max, available_tonight, availability, response_mins, gigs_played, verified, seed) values
  ...
  ('m-theo', 'Theo Park', 'theoparkkeys', 'Keys for jazz trios, soul revues, and everything between. Berklee dropout (best decision I ever made). Rhodes, organ, synth bass if your bassist bails too.', ARRAY['Jazz', 'Soul', 'Neo-Soul'], ARRAY['Nord Stage 3', 'Crumar Mojo organ', 'Own PA for small rooms'], 'Mueller', 2.5, 130, 210, true, ARRAY['Mon', 'Thu', 'Fri', 'Sat'], 10, 275, true, 8),
  ('m-ada', 'Ada Osei', 'adaosei', 'Music director, keys, and vocals. I run Brass House ATX''s horn-driven soul machine. Available for MD work, session dates, and the occasional wedding that pays properly.', ARRAY['Gospel', 'Soul', 'R&B'], ARRAY['Yamaha CP88', 'Full charts library'], 'Windsor Park', 3.1, 150, 250, false, ARRAY['Sat', 'Sun'], 25, 330, true, 9),
  ('m-cass', 'Cass Monroe', 'cassmonroe', 'Jazz vocalist. Standards, torch songs, and the occasional Bowie cover when the room earns it. Fronting Velvet Hour Thursdays at the Rattlesnake Room.', ARRAY['Jazz', 'Soul', 'Standards'], ARRAY['Own mic (SM58 Beta + vintage ribbon for studio)'], 'Clarksville', 4.2, 140, 230, true, ARRAY['Thu', 'Fri', 'Sat'], 18, 190, true, 10),
  ('m-ray', 'Ray Delgado', 'raydelgadosax', 'Tenor and alto sax. Horn section arranger — book me and I''ll bring charts for your whole section. Ska past, no regrets.', ARRAY['Funk', 'Jazz', 'Ska'], ARRAY['Selmer Mark VI tenor', 'Yamaha alto', 'Wireless clip mic'], 'East Austin', 1.5, 100, 170, true, ARRAY['Wed', 'Fri', 'Sat'], 30, 265, true, 11),
  ('m-belle', 'Belle Tran', 'belletran', 'Trumpet + flugelhorn. UT music grad. I read anything you put in front of me and I show up warmed up.', ARRAY['Funk', 'Latin', 'Indie'], ARRAY['Bach Stradivarius', 'Flugelhorn', 'Harmon mute for the moody stuff'], 'North Loop', 3.6, 80, 140, false, ARRAY['Fri', 'Sat', 'Sun'], 40, 95, false, 12),
  ('m-ivy', 'Ivy Nakamura', 'ivyfiddle', 'Fiddle for barn dances, violin for weddings — same instrument, different invoice. Harmony vocals included free of charge.', ARRAY['Folk', 'Americana', 'Bluegrass'], ARRAY['5-string fiddle', 'Own pickup + preamp'], 'Zilker', 4.8, 90, 160, true, ARRAY['Thu', 'Sat', 'Sun'], 22, 178, true, 13),
  ('m-kilo', 'DJ Kilowatt', 'djkilowatt', 'Open-format DJ + Ableton live sets. I do club nights, band interludes, and after-parties. Own controller, own lights, zero requests for ''Mr. Brightside'' honored.', ARRAY['House', 'Disco', 'Hip-Hop'], ARRAY['Pioneer DDJ-1000', 'Ableton Push', 'Small LX rig'], 'Downtown', 2.9, 150, 300, true, ARRAY['Thu', 'Fri', 'Sat'], 14, 320, true, 14),
  ('m-gus', 'Gus Ferreira', 'gusfoh', 'FOH engineer. I''ve mixed everything from punk basements to 1,200-cap rooms. Your band sounds better when the person behind the desk cares — I care.', ARRAY['Live Sound', 'FOH', 'Monitors'], ARRAY['Own mic locker', 'X32 rack for DIY rooms', 'RF coordination'], 'St. Johns', 5.2, 150, 275, true, ARRAY['Wed', 'Thu', 'Fri', 'Sat'], 16, 410, true, 15),
  ('m-pri', 'Priya Anand', 'priyalights', 'Lighting design + live visuals. I make your $200 bar gig look like a $20 ticket. Touring rig fits in a hatchback.', ARRAY['Lighting', 'Visuals', 'Projection'], ARRAY['4x moving heads', 'Hazer', 'Resolume rig for projections'], 'Riverside', 3.8, 90, 180, false, ARRAY['Fri', 'Sat'], 50, 120, false, 16)
